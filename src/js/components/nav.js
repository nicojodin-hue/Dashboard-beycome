...
export function renderNav() {
    ...
    <div class="nav-container">
        <ul class="nav-menu">
            ...
            <li class="nav-item"><a href="/offers" class="nav-link">Offers<span class="nav-badge">1</span></a></li>
            ...
            <li class="nav-item"><a href="/collection" class="nav-link">Favorites</a></li>
            ...
            <li class="nav-item" style="position: relative;">
                ...
                <div class="menu right" id="toolsMenu">
                    ...
                    <a href="javascript:void(0)" class="menu-item" id="navMarketTrendsLink">Market Trends</a>
                </div>
            </li>
        </ul>
    </div>`;
...
export function initNav() {
    ...
    const mtLink = document.getElementById('navMarketTrendsLink');
    if (mtLink) mtLink.addEventListener('click', () => { window.location.hash = '/market-trends'; });
}
...
function setGreeting() {
    ...
    if (el) el.innerHTML = g + ' John! <span style="font-size: 20px; line-height: 1;">' + i + '</span>';
}
