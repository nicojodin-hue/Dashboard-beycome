...
export function renderHeader() {
    return `<div class="main-header-container">
        <div class="main-header-left"><a href="#">Sell</a><a href="#">Buy</a><a href="javascript:void(0)" id="headerTitleLink">Title services</a></div>
...
export function initHeader() {
    ...
    const titleLink = document.getElementById('headerTitleLink');
    if (titleLink) titleLink.addEventListener('click', () => { closeAllDropdowns(); window.location.hash = '/title'; });
